...
//****************************************************************************************
require 'path.php';
init_cobalt('View employeebridgerecord');

$page_title       = 'ListView: %%';
$db_subclass      = 'employeebridgerecord';
$html_subclass    = 'employeebridgerecord_html';
$arr_pkey_name    = array();
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add employeebridgerecord';
$edit_link        = 'Edit employeebridgerecord';
$delete_link      = 'Delete employeebridgerecord';
$view_link        = 'View employeebridgerecord';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_employeebridgerecord.php';
$edit_page        = 'edit_employeebridgerecord.php';
$delete_page      = 'delete_employeebridgerecord.php';
$view_page        = 'detailview_employeebridgerecord.php';
$csv_page         = 'csv_employeebridgerecord.php';
$report_page      = 'reporter_employeebridgerecord.php';
