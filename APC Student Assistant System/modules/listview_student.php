...
$page_title       = 'ListView: %%';
$db_subclass      = 'student';
$html_subclass    = 'student_html';
$arr_pkey_name    = array('Student_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add student';
$edit_link        = 'Edit student';
$delete_link      = 'Delete student';
$view_link        = 'View student';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_student.php';
$edit_page        = 'edit_student.php';
$delete_page      = 'delete_student.php';
$view_page        = 'detailview_student.php';
$csv_page         = 'csv_student.php';
$report_page      = 'reporter_student.php';
