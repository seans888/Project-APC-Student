...
//****************************************************************************************
require 'path.php';
init_cobalt('View studentbridgeterm');

$page_title       = 'ListView: %%';
$db_subclass      = 'studentbridgeterm';
$html_subclass    = 'studentbridgeterm_html';
$arr_pkey_name    = array();
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add studentbridgeterm';
$edit_link        = 'Edit studentbridgeterm';
$delete_link      = 'Delete studentbridgeterm';
$view_link        = 'View studentbridgeterm';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_studentbridgeterm.php';
$edit_page        = 'edit_studentbridgeterm.php';
$delete_page      = 'delete_studentbridgeterm.php';
$view_page        = 'detailview_studentbridgeterm.php';
$csv_page         = 'csv_studentbridgeterm.php';
$report_page      = 'reporter_studentbridgeterm.php';
