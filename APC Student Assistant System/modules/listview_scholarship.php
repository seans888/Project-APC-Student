...
//****************************************************************************************
require 'path.php';
init_cobalt('View scholarship');

$page_title       = 'ListView: %%';
$db_subclass      = 'scholarship';
$html_subclass    = 'scholarship_html';
$arr_pkey_name    = array('Scholarship_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add scholarship';
$edit_link        = 'Edit scholarship';
$delete_link      = 'Delete scholarship';
$view_link        = 'View scholarship';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_scholarship.php';
$edit_page        = 'edit_scholarship.php';
$delete_page      = 'delete_scholarship.php';
$view_page        = 'detailview_scholarship.php';
$csv_page         = 'csv_scholarship.php';
$report_page      = 'reporter_scholarship.php';
