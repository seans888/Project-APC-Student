...
//****************************************************************************************
require 'path.php';
init_cobalt('View reserve');

$page_title       = 'ListView: %%';
$db_subclass      = 'reserve';
$html_subclass    = 'reserve_html';
$arr_pkey_name    = array('Reserve_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add reserve';
$edit_link        = 'Edit reserve';
$delete_link      = 'Delete reserve';
$view_link        = 'View reserve';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_reserve.php';
$edit_page        = 'edit_reserve.php';
$delete_page      = 'delete_reserve.php';
$view_page        = 'detailview_reserve.php';
$csv_page         = 'csv_reserve.php';
$report_page      = 'reporter_reserve.php';
