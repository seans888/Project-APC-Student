...
class studentbridgereserve extends data_abstraction
{
    var $fields = array();
    ...
    function add($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_fields('Reserve_Reserve_id, Student_Student_id');
            $this->set_values("?,?");
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_update("Reserve_Reserve_id = ?, Student_Student_id = ?");
            $this->set_where("");
