<?php
define('GLOBAL_PROJECT_NAME', 'APC Student Assistant System');
define('GLOBAL_SESSION_NAME', 'Caa302760');

//Default database settings
define('DEFAULT_DB_HOST','localhost');
define('DEFAULT_DB_USER','root');
define('DEFAULT_DB_PASS','');
define('DEFAULT_DB_USE' ,'apc');

//Paths and directory names
define('BASE_DIRECTORY', 'APC_Student_Assistant_System');
